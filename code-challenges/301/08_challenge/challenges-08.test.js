...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let newArr = arr.filter(element => element.baseStat > minBaseStat);
  return newArr;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let newArr = arr.filter(element => element.baseStat > minBaseStat);
  let newArr2 = newArr.map(element => element.stat.name);
  return newArr2;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  let newArr = arr.filter(element => !element.children);
  return newArr;
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let newArr = arr.filter(element => typeof element === 'number');
